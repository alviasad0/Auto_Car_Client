                ...
                <div className="card md:px-10">
                  ...
                  >
                    <h2 className="text-2xl text-black font-bold">
                      ...
                      <div className="badge badge-success p-2 ml-2">Latest</div>
                    </h2>
                    <p className="text-lg font-medium">
                      The Mercedes-Benz C-Class is a sporty and stylish compact
                      luxury car known for its performance and upscale features.
                    </p>
              ...
              <div>
                <div className="mx-auto card md:px-10">
                  ...
                  >
                    ...
                    <p className="text-lg font-medium">
                      Ferrari F8 Tributo price starts at $ 4.02 Cr and goes upto
                      $ 4.02 Cr (Ex-showroom). Ferrari F8 Tributo comes in 1
                      variants. Ferrari F8 Tributo top variant price is $ 4.02
                      Cr.
                    </p>
                    <div className="card-actions justify-end">
                      <button className="btn btn-success border-2 border-green-600">
